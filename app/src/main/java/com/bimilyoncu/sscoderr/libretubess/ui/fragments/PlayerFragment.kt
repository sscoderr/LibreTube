...
import com.bimilyoncu.sscoderr.libretubess.compat.PictureInPictureParamsCompat
...
import com.bimilyoncu.sscoderr.libretubess.databinding.FragmentPlayerBinding
...
import com.bimilyoncu.sscoderr.libretubess.enums.PlayerEvent
...
import com.bimilyoncu.sscoderr.libretubess.extensions.serializableExtra
...
import com.bimilyoncu.sscoderr.libretubess.helpers.PlayerHelper.checkForSegments
import com.bimilyoncu.sscoderr.libretubess.helpers.PlayerHelper.isInSegment
...
import com.bimilyoncu.sscoderr.libretubess.helpers.WindowHelper
import com.bimilyoncu.sscoderr.libretubess.obj.ShareData
import com.bimilyoncu.sscoderr.libretubess.obj.VideoResolution
...
import com.bimilyoncu.sscoderr.libretubess.ui.dialogs.PlayOfflineDialog
import com.bimilyoncu.sscoderr.libretubess.ui.dialogs.ShareDialog
import com.bimilyoncu.sscoderr.libretubess.ui.extensions.animateDown
...
import com.bimilyoncu.sscoderr.libretubess.ui.interfaces.OnlinePlayerOptions
import com.bimilyoncu.sscoderr.libretubess.ui.listeners.SeekbarPreviewListener
import com.bimilyoncu.sscoderr.libretubess.ui.models.ChaptersViewModel
import com.bimilyoncu.sscoderr.libretubess.ui.models.CommentsViewModel
import com.bimilyoncu.sscoderr.libretubess.ui.models.CommonPlayerViewModel
import com.bimilyoncu.sscoderr.libretubess.ui.models.PlayerViewModel
import com.bimilyoncu.sscoderr.libretubess.ui.sheets.BaseBottomSheet
import com.bimilyoncu.sscoderr.libretubess.ui.sheets.CommentsSheet
import com.bimilyoncu.sscoderr.libretubess.ui.sheets.StatsSheet
import com.bimilyoncu.sscoderr.libretubess.util.OnlineTimeFrameReceiver
...
class PlayerFragment : Fragment(R.layout.fragment_player), OnlinePlayerOptions {
    ...
    private fun initializeOnClickActions() {
        ...
        binding.relPlayerShare.setOnClickListener {
            ...
            // Create share URL
            val shareUrl = if (PreferenceHelper.getBoolean(PreferenceKeys.SHARE_WITH_TIME_CODE, false)) {
                // Include current timestamp if preference is enabled
                val timestamp = playerController.currentPosition / 1000
                "${ShareDialog.YOUTUBE_SHORT_URL}/${videoId}&t=${timestamp}"
            } else {
                // Basic video URL without timestamp
                "${ShareDialog.YOUTUBE_SHORT_URL}/${videoId}"
            }
            
            // Create and launch system share intent directly
            val intent = Intent(Intent.ACTION_SEND)
                .putExtra(Intent.EXTRA_TEXT, shareUrl)
                .putExtra(Intent.EXTRA_SUBJECT, streams.title)
                .setType("text/plain")
    ...
    private fun updateControlledFeaturesVisibility() {
        ...
        if (cachedStatus == null) {
            ...
            binding.relPlayerDownload.isVisible = false
            binding.relPlayerBackground.isVisible = false
            binding.relPlayerShare.isVisible = false
            binding.relPlayerExternalPlayer.isVisible = false
            ...
            viewLifecycleOwner.lifecycleScope.launch {
                ...
                if (shouldShowControls && isAdded && _binding != null) {
                    ...
                    // Update share button - always visible if controls are enabled
                    binding.relPlayerShare.isVisible = true
                    
                    // Update external player button - always visible if controls are enabled
                    binding.relPlayerExternalPlayer.isVisible = true
                }
            }
            ...
            // Share button - always visible if controls are enabled
            binding.relPlayerShare.isVisible = true
            
            // External player button - always visible if controls are enabled
            binding.relPlayerExternalPlayer.isVisible = true
        } else {
