...
import com.bimilyoncu.sscoderr.libretubess.util.YoutubeHlsPlaylistParser
...
open class OnlinePlayerService : AbstractPlayerService() {
    ...
    private fun playAudio(seekToPosition: Long) {
        ...
        } else if (watchPositionsEnabled && resumeFromSavedPosition && PlayerHelper.shouldTrackVideoPosition(videoId)) {
