...
import com.bimilyoncu.sscoderr.libretubess.LibreTubeApp
...
import com.bimilyoncu.sscoderr.libretubess.enums.SbSkipOptions
...
object PlayerHelper {
    ...
    fun getSponsorBlockCategories(): MutableMap<String, SbSkipOptions> {
        ...
        for (category in LibreTubeApp.instance.resources.getStringArray(
            ...
            val skipOption = PreferenceHelper.getString(
                "${category}_category",
    ...
    fun setPreferredCodecs(trackSelector: DefaultTrackSelector) {
        trackSelector.updateParameters {
            val enabledVideoCodecs = enabledVideoCodecs
            ...
            val enabledAudioCodecs = enabledAudioCodecs
